      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center px-6 sm:px-16 z-10">
        <div className="w-full max-w-7xl mx-auto flex flex-col items-center justify-center">
          ...
          >
            ...
            >
             I analyze and interpret data to uncover meaningful insights while ensuring digital security through cybersecurity strategies. With expertise in Power BI, Advanced Excel, SQL, and security analytics, I create data-driven solutions that enhance efficiency and security. My goal is to merge analytical thinking with technology to solve complex problems and drive impactful results.
            </motion.p>
