    ...
    <footer className="relative w-full py-10 bg-tertiary">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          >
            <h2 className="text-white text-2xl font-bold">Mayank Tarneja</h2>
            <p className="text-secondary mt-1"> DATA & SECURITY ANALYST</p>
          </motion.div>
          ...
          >
            ...
            <motion.a
              href="www.linkedin.com/in/mayank-tarneja-a6577a270"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-full bg-black/20 flex items-center justify-center text-white hover:text-electric-cyan transition-colors"
              whileHover={{ scale: 1.1 }}
         ...
         {/* //jfeifn */}
            <motion.a
              href="https://www.instagram.com/mayank_tarneja_1705?igsh=cW12dHJ1N2I4dXJx&utm_source=qr"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-full bg-black/20 flex items-center justify-center text-white hover:text-electric-cyan transition-colors"
              whileHover={{ scale: 1.1 }}
