    ...
    <section id="skills" className="relative w-full min-h-screen mx-auto py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          I have worked with a variety of technologies in data analytics, cybersecurity, and web development. From building responsive front-end interfaces to securing data-driven applications, I specialize in creating efficient and scalable solutions with Power BI, SQL, cybersecurity analytics, and modern web technologies.
          </p>
        </motion.div>
